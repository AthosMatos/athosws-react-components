    ...
    useEffect(() => {
        ...
        const mousemove = (e: MouseEvent) => {
            ...
            if (indicatorPosition) {
                ...
                borderIndicator.style.height =
                    sizeStyle === 2 ? "20px" : "10px";
        ...
        const mousedown = (e: MouseEvent) => {
            ...
            const onEdge = {
                right:
                    distances.right <= clickThreshold && resizableConers.right,
                bottom:
                    distances.bottom <= clickThreshold &&
                    resizableConers.bottom,
